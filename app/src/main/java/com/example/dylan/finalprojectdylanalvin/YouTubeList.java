...
public class YouTubeList extends BaseAdapter implements YouTubeThumbnailView.OnInitializedListener {
    ...
    public YouTubeList(final Context context) {
        mContext = context;
    ...
    @Override
    public int getCount() {
        return YoutubeHelper.ITEMS.size();
    }

    @Override
    public Object getItem(int position) {
        return YoutubeHelper.ITEMS.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final YoutubeHelper.YouTubeVideo item = YoutubeHelper.ITEMS.get(position);
